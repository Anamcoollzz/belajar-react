...
function Sidebar(props) {
  const activeProps = props.active || window.location.pathname;
  // const match = useRouteMatch();
  const history = useHistory();
  const [active, setActive] = useState(activeProps);
  // console.log(match);
  // useEffect(() => {
  //   // console.log("active", match.path);
  // }, [match]);
    ...
    <div className="main-sidebar">
      <aside id="sidebar-wrapper">
        ...
        <ul className="sidebar-menu">
          ...
          <li
            className={
              active == "/" ? "nav-item dropdown active" : "nav-item dropdown"
            }
          >
          ...
          <li className={props.active == "datatable" ? "active" : ""}>
            <a href="#" className="nav-link has-dropdown">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              ...
              <li>
                <a className="beep beep-sidebar" href="auth-login-2.html">
                  Login 2
                </a>
              </li>
              <li>
